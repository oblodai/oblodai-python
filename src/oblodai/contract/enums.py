...
PaymentStatusArg = Union[PaymentStatus, str]
...
PayoutStatusArg = Union[PayoutStatus, str]

PAYOUT_LINK_STATUSES: Tuple[str, ...] = (
    "funded",
    "claiming",
    "claimed",
    "expired",
...
PayoutLinkStatus = Literal["funded", "claiming", "claimed", "expired", "cancelled"]
PayoutLinkStatusArg = Union[PayoutLinkStatus, str]
...
DeliveryStatusArg = Union[DeliveryStatus, str]
...
NetworkArg = Union[Network, str]

FEE_BEARERS: Tuple[str, ...] = (
    "recipient",
    "merchant",
)
FeeBearer = Literal["recipient", "merchant"]
FeeBearerArg = Union[FeeBearer, str]

FEE_BEARER_RESULTS: Tuple[str, ...] = (
    "recipient",
    "merchant",
    "gateway",
)
FeeBearerResult = Literal["recipient", "merchant", "gateway"]
FeeBearerResultArg = Union[FeeBearerResult, str]

BATCH_ON_ERRORS: Tuple[str, ...] = (
    "continue",
    "stop",
)
BatchOnError = Literal["continue", "stop"]
BatchOnErrorArg = Union[BatchOnError, str]

WEBHOOK_KINDS: Tuple[str, ...] = (
    "payment",
    "payout",
    "wallet",
)
WebhookKind = Literal["payment", "payout", "wallet"]
WebhookKindArg = Union[WebhookKind, str]
...
ErrorKindArg = Union[ErrorKind, str]

AMOUNT_MODES: Tuple[str, ...] = (
    "fixed",
    "open",
    "range",
)
AmountMode = Literal["fixed", "open", "range"]
AmountModeArg = Union[AmountMode, str]
...
EventTypeArg = Union[EventType, str]
...
ErrorCodeArg = Union[ErrorCode, str]
